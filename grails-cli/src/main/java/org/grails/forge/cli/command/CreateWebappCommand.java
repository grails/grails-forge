...
@Prototype
public class CreateWebappCommand extends CreateCommand {

    public static final String NAME = "create-webapp";
    ...
    public CreateWebappCommand(WebAvailableFeatures availableFeatures,
