...
class GebSpec extends ApplicationContextSpec implements CommandOutputFixture {
    ...
    void "test dependencies"() {
        ...
        buildGradle.contains("testImplementation(\"org.seleniumhq.selenium:selenium-api:4.8.3\")")
        buildGradle.contains("testImplementation(\"org.seleniumhq.selenium:selenium-support:4.8.3\")")
        buildGradle.contains("testImplementation(\"org.seleniumhq.selenium:selenium-remote-driver:4.8.3\")")
        buildGradle.contains("testRuntimeOnly(\"org.seleniumhq.selenium:selenium-chrome-driver:4.8.3\")")
        buildGradle.contains("testRuntimeOnly(\"org.seleniumhq.selenium:selenium-firefox-driver:4.8.3\")")
    }
